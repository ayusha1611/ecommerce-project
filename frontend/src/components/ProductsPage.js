      ...
      <div style={{ display: 'flex', gap: '30px' }}>
        ...
        <div style={{ width: '250px', flexShrink: 0 }}>
          <div style={{ 
            ...
            <h3 style={{ fontSize: '20px', marginBottom: '20px', color: '#2e3192' }}>
              Products
            </h3>
            ...
            <button
              ...
              style={{
                ...
                marginBottom: '8px',
                border: 'none',
                backgroundColor: selectedCategory === 'all' ? '#2e3192' : 'transparent',
            ...
            {categories.map(cat => (
              <button
                ...
                style={{
                  ...
                  marginBottom: '8px',
                  border: 'none',
                  backgroundColor: selectedCategory === cat.name ? '#2e3192' : 'transparent',
            ...
            {categories.length === 0 && (
              <p style={{ fontSize: '14px', color: '#999', textAlign: 'center', marginTop: '10px' }}>
    ...
    >
      ...
      <div style={{ padding: '15px', textAlign: 'center' }}>
        <div style={{ 
          ...
          ₹{product.price}
          <span style={{ fontSize: '13px', color: '#666', fontWeight: 'normal' }}>/pc</span>
        </div>
